      ...
      <div className="sd-hero" style={{ backgroundImage:`url(${movie.banner || movie.poster})` }}>
        ...
        <div className="sd-hero-content">
          <div className="sd-meta-row">
            ...
            {movie.ageRating && <span className="sd-age">{movie.ageRating}</span>}
          </div>

          <h1 className="sd-title">{movie.title}</h1>

          {movie.description && <p className="sd-desc">{movie.description}</p>}

          <div className="sd-actions">
            <button className="sd-btn-play" onClick={() => navigate(`/watch/${movie._id}`)}>
...
.sd-pill { font-size: 13px; color: rgba(255,255,255,0.72); font-family: 'Outfit', sans-serif; }
...
.sd-body { background: var(--bg-base); padding: 40px 5% 80px; font-family: 'Outfit', sans-serif; }
.sd-trailer { max-width: 760px; }
.sd-section-heading {
